...
echo Changing instance type to %TARGET_TYPE% (64 GB RAM)...
...
echo.
echo =========================================
echo  Instance upsized to %TARGET_TYPE% (64 GB)
echo  Instance ID : %INSTANCE_ID%
echo  Public IP   : %PUBLIC_IP%
echo  Connect with:
echo  ssh -i C:\Users\daraujo\Downloads\indot-pipeline-key.pem ubuntu@%PUBLIC_IP%
echo.
echo  Run script 08, then execute downsize-ec2.bat when done.
echo =========================================
